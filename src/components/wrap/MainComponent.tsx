...
export default function MainComponent() {
   ...
   * ------------------------------ **/    
    const {
        ...
        onSearch,
        resetSearch,
    } = useFilterSortComponent(({ period, condition, keyword }) => {
        let result = [...할일목록];
   ...
   * ------------------------------ **/
    ...
    * ----------------------------------------- **/
    const {
        ...
        onClickDeleteBtn,
        onClickRestoreBtn,
    } = useTodoListComponent({ set할일목록, openModal, setUpdate});


    const { 완료된개수, onClickCheckDeleteBtn } = useSelectDeleteComponent({
        할일목록,
        set할일목록,
        openModal,
    });
