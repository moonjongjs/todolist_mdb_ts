...
### 1️⃣ 저장소 클론
```bash
git clone https://github.com/your-repo/next_new_todolist.git
cd next_new_todolist
```
...
## 🌐 배포
- **Vercel 배포 주소** 👉 [Demo Link](https://your-vercel-project.vercel.app)  
- **GitHub Repository** 👉 [GitHub Link](https://github.com/your-repo)  
